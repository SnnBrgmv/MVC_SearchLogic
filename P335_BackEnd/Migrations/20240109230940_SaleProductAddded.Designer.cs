...
namespace P335_BackEnd.Migrations
{
    ...
    [Migration("20240109230940_SaleProductAddded")]
    partial class SaleProductAddded
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("P335_BackEnd.Entities.ProductTypeProduct", b =>
                {
                    ...
                    b.ToTable("ProductTypesProducts");
                });

            modelBuilder.Entity("P335_BackEnd.Entities.SaleProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
